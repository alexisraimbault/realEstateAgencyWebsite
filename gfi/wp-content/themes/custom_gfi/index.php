...
<div class = "bg_images" id = "index">
  ...
  <div class = "image1" id = "img1">
    ...
    <div class="btn btn1 middle"onmouseover="Javascript:highlight(1)" onmouseout="Javascript:unHighlight(1)" onClick="document.location.href='gestion'">
     <a href="#">Gestion</a>
    </div>
  ...
  <div class = "image2" id = "img2">
    ...
    <div class="btn btn1 middle"onmouseover="Javascript:highlight(2)" onmouseout="Javascript:unHighlight(2)" onClick="document.location.href='vente'">
     <a href="#" >Vente</a>
    </div>
  ...
  <div class = "image3" id = "img3">
    ...
    <div class="btn btn1 middle" onmouseover="Javascript:highlight(3)" onmouseout="Javascript:unHighlight(3)" onClick="document.location.href='location'">
     <a href="#">Location</a>
    </div>
  ...
  <div class = "image4" id = "img4">
    ...
    <div class="btn btn1 middle" onmouseover="Javascript:highlight(4)" onmouseout="Javascript:unHighlight(4)" onClick="document.location.href='entreprise'">
     <a href="#">Entreprise</a>
    </div>
